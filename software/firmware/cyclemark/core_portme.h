...
/*
 * riscv-core-harness
 * No float supported by the core.
 */
// #define HAS_FLOAT 1
#define HAS_FLOAT 0
/**/
...
/*
 * riscv-core-harness
 * No time instructions supported by the core.
 */
// #define HAS_TIME_H 1
#define HAS_TIME_H 0
/**/
...
/*
 * riscv-core-harness
 * New definition of CORE_TICKS.
 */
typedef uint32_t CORE_TICKS;
// #error "Please define type of CORE_TICKS and implement start_time, end_time get_time and
// time_in_secs functions!"
/**/
...
// #define MEM_LOCATION "Please put data memory location here\n\t\t\t(e.g. code in flash, data on
// heap etc)" #define MEM_LOCATION_UNSPEC 1
#endif
...
/*
 * riscv-core-harness
 * printf function redefinition (embedded printf)
 */
